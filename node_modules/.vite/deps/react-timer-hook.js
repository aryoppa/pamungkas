    ...
    !function(e, t) {
      ...
      return (() => {
        ...
        function u() {
          ...
          const [n2, i2] = (0, e2.useState)(r2.getSecondsFromExpiry(o2, true) || 0), [a2, c2] = (0, e2.useState)(new Date()), [u2, m2] = (0, e2.useState)(n2 + r2.getSecondsFromPrevTime(a2 || 0, true)), [l2, d] = (0, e2.useState)(t3);
          s(() => {
          ...
          const p = (0, e2.useCallback)(() => {
            ...
            const o3 = r2.getSecondsFromExpiry(e3, true) || 0, n3 = new Date();
