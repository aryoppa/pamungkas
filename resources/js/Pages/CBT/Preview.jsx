...
export default function Preview(props) {
    ...
    const onSubmit = () => {
        location.replace('/cbt/admin-test-detail/' + props.testCode)
    }
                    ...
                    <div className="bg-[#3e6d81] pb-32">
                        <header className="py-10">
                            <div className="mx-auto max-w-screen px-4 sm:px-6 lg:px-8">
                                ...
                                <h1 className="text-5xl font-bold tracking-tight text-white">Test Preview</h1>
                                </div>
                            </div>
                        </header>   
                    </div>
                                    ...
                                    <div className="flex flex-row ">
                                        ...
                                        <div className="basis-1/3 p-5 ml-3 rounded-lg"
                                            ...
                                            <ResultQuestionNumBox questions={
                                                ...
                                                flags={new Map(questions.map(({ question_id, status }) => [question_id, status]))}
                                    ...
                                    <div className="row w-full mt-5">
                                        <div className="card p-5 w-full rounded-lg"
                                            ...
                                            <ResultQuestion 
                                                ...
                                                user_answer={questions[questionIndex - 1].user_answer}
                                            />
                                        </div>
                                    </div>
                                </div>
