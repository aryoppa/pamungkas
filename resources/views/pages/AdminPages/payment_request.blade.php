                ...
                <table class="table mt-2">
                    <thead>
                        <tr>
                            ...
                            <th style="color: #CA6035;"> Status payment </th>
                            <th style="color: #CA6035;"> balance </th>
                    ...
                    <tbody>
                        ...
                        @if ($data->payment_request == 'request')
                            <tr>
                                <td>
                                    -
                                </td>
                                ...
                                <td>
                                    ...
                                    @elseif ($data->payment_request == 'failed')
                                ...
                                <td>
                                    ...
                                    <a href="{{ asset('storage/' . $data->payment_receipt) }}" target="_blank">Lihat</a>
                                    @else
                                    No Receipt
                                    @endif
                                </td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pt-3">
                                                    Are you sure want to accept request payment this user?
                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pt-3 pb-3">
                                                    Are you sure want to decline request payment this user?
                                                </div>
                                                <div class="modal-footer">
          ...
          <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                ...
                <table class="table mt-2">
                    ...
                    <tbody>
                        @foreach ($datas as $data)
                        @if ($data->payment_request == 'success')
                            <tr>
                                <td>
                                    -
                                </td>
          ...
          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                ...
                <table class="table mt-2">
                    ...
                    <tbody>
                        @foreach ($datas as $data)
                        @if ($data->payment_request == 'failed')
                            <tr>
                                <td>
                                    -
                                </td>
